...
setwd(paste("C:/Users/clu73519/Repos/Udacity/",
            "Exploratory_Data_Analysis/p6_explore_and_summarize_data", sep=""))


# Greg's macbook
# setwd(paste("/Users/GregoryClunies/Repos/Udacity/Exploratory_Data_Analysis/",
#             "p6_explore_and_summarize_data", sep=""))
```
...
library(dplyr)  # make sure dplyr functions are default, not data.table function
...
# comment out 2 lines below after downloading, otherwise code hangs
...
kable(loan.count_by_term_status, 
      caption = "Loan Term vs. Loan Status Summary Table")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
df_loan$Actual_less_Estimated_Return <- df_loan$ActualReturn - 
  df_loan$EstimatedReturn
...
kable(g_cor_BorrowerRate, 
      caption = "Estimated vs Actual Return - by Borrower Rate")
...
kable(g_cor_ProsperRatingAlpha, 
      caption = "Estimated vs Actual Return - by Borrower Rate")
...
kable(g_cor_ProsperScore, 
      caption = "Estimated vs Actual Return - by Prosper Score")
...
kable(g_cor_BorrowerState, 
      caption = "Estimated vs Actual Return - by Borrower State")
...
kable(g_cor_EmploymentStatus, 
      caption = "Estimated vs Actual Return - by Employment Status")
...
kable(g_cor_ListingCategory, 
      caption = "Estimated vs Actual Return - by Listing Category")
...
kable(g_cor_CreditScore, 
      caption = "Estimated vs Actual Return - by Credit Score")
...
kable(g_cor_DebtToIncomeRatio, 
      caption = "Estimated vs Actual Return - by Debt to Income Ratio")
...
kable(g_cor_MonthlyLoanPayment, 
      caption = "Estimated vs Actual Return - by Monthly Loan Payment")
...
kable(g_cor_BorrowerRate, col.names = c("Borrower Rate", "Correlation"), 
      caption = "Correlation by Borrower Rate")
```
